...
unset($__errorArgs, $__bag); ?>" id="password" name="password" placeholder="Senha" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center text-muted small mt-4 mb-0">
                    ...
                    <a href="<?php echo e(route('regular.register')); ?>" class="text-decoration-none fw-semibold" style="color: var(--primary-green);">Criar conta</a>
                </p>
...
</html><?php /**PATH C:\Users\47808487848\Herd\redesocialweb\resources\views/auth/regular/login.blade.php ENDPATH**/ ?>