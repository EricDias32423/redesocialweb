...
<body class="p-4">
    <div class="container" style="max-width:540px;margin-top:40px;">
        ...
        <form id="resetForm">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="btn btn-link">Enviar novo código</a>
        </form>
    </div>
    ...
    document.getElementById('resetForm').addEventListener('submit', async function(e){
        ...
        try {
            ...
            if (res.ok) {
                ...
                setTimeout(function(){
                    window.location.href = '<?php echo e(route("choose.role")); ?>';
                }, 1200);
            } else {
...
<?php /**PATH C:\Users\47808487848\Herd\redesocialweb\resources\views/auth/reset-password-code.blade.php ENDPATH**/ ?>