...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Olá, <?php echo e($user->name ?? $user->ong_name); ?>! 👋</h2>
            ...
            <a href="<?php echo e(config('app.url')); ?>" class="button">Explorar a plataforma</a>
        </div>
...
</html><?php /**PATH C:\Users\47808487848\Herd\redesocialweb\resources\views/emails/welcome.blade.php ENDPATH**/ ?>